...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Blogway web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 2Zi4kj7k9HJyXH0gTO4ez_46lVwv22M_aGdqnnqSyRg
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("blogway.log", "w"))
  #
  #
end
